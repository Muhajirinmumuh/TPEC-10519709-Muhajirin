            ...
            <div class="col-lg-12">
                <form action="{{ url('/produk/create', @$produk->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input value="{{ old('harga_produk', @$produk->harga_produk) }}" step="0.01" type="number" class="form-control" name="harga_produk" id="harga_produk" placeholder="Harga Produk">
                        </div>
                    </div>
